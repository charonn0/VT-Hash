...
Protected Module Errors
	#tag Method, Flags = &h1
		Protected Function Name(CURLCODE As Integer) As String
		  ...
		  "CURLE_FTP_WEIRD_SERVER_REPLY", "CURLE_FTP_ACCESS_DENIED", "CURLE_FTP_ACCEPT_FAILED", "CURLE_FTP_WEIRD_PASS_REPLY", _
		  "CURLE_FTP_ACCEPT_TIMEOUT", "CURLE_FTP_WEIRD_PASV_REPLY", "CURLE_FTP_WEIRD_227_FORMAT", "CURLE_FTP_CANT_GET_HOST", _
		  "CURLE_HTTP2", "CURLE_FTP_COULDNT_SET_BINARY", "CURLE_PARTIAL_FILE", "CURLE_FTP_COULDNT_RETR_FILE", "CURLE_FTP_WRITE_ERROR", _
		  ...
		  "CURLE_TOO_MANY_REDIRECTS ", "CURLE_UNKNOWN_OPTION", "CURLE_TELNET_OPTION_SYNTAX ", "CURLE_OBSOLETE", "CURLE_PEER_FAILED_VERIFICATION", _
		  ...
		  "CURLE_CONV_REQD", "CURLE_SSL_CACERT_BADFILE", "CURLE_REMOTE_FILE_NOT_FOUND", "CURLE_SSH", "CURLE_SSL_SHUTDOWN_FAILED", "CURLE_AGAIN", _
